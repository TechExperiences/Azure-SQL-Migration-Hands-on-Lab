# Exercise 4: Perform the Database Migration
...
### Task 4.1: Configure the Source Database in Migration Wizard
...
### Task 4.2: Configure the Target Database in Migration Wizard
...
### Task 4.3: Select the Source Schema Objects to Migrate
